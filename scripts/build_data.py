...
def build_context(sa, w2):
    ...
    ctx = {
        ...
        "데이터정의": {
            ...
            "지역기준": "사람인은 공고에 표기된 근무지 기준, work24는 사업장 소재지 기준. 둘의 지역 정의가 다름.",
            "work24_신규구인": "고용행정통계(워크넷) 신규구인 인원수. 월 단위 마감치.",
            "work24_신규구직": "워크넷 신규구직 건수. 월 단위 마감치.",
            "work24_취업건수": "워크넷을 통한 취업 건수. 월 단위 마감치.",
    ...
    if w2:
        ctx["work24"] = {
            "최근마감월": w2["latest_ym"],
            "월별": [{"ym": y, "신규구인": a, "신규구직": b, "취업건수": c}
                    for y, a, b, c in zip(w2["yms"], w2["신규구인"],
                                          w2["신규구직"], w2["취업건수"])],
